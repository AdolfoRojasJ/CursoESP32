...
#define R_res 16   //Resolución PEM
...
#define G_res 16   //Resolución PEM
...
#define B_res 16   //Resolución PEM
...
void setup() {
  ...
  Serial.println();
  Serial.println("Control de un led RGB por Bluetooth");
  Serial.println();
}
